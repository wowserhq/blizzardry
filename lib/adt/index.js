var Chunk, Chunked, MCLY, MCNK, MCNR, MCVT, MHDR, MMDX, MTEX, SkipChunk, Vec3Float, floatle, int32le, int8, r, uint16le, uint32le, uint8, _ref;

r = require('restructure');

_ref = require('../types'), floatle = _ref.floatle, int8 = _ref.int8, int32le = _ref.int32le, uint8 = _ref.uint8, uint16le = _ref.uint16le, uint32le = _ref.uint32le, Vec3Float = _ref.Vec3Float;
